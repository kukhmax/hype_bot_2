...
async def start_handler(message: Message):
    ...
    await message.answer(
        (
            ...
            "Этот бот даёт сигналы по рынку Hyperliquid на основе ML Adaptive Supertrend с подтверждением ADX ≥ 20.\n\n"
            "Что означают настройки при подписке:\n"
            "• Тикер, по которому хотите получать сигналы (например, BTC, ETH).\n"
