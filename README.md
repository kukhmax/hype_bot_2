...
(без реальных ордеров на бирже), с расчётом ордеров/позиций/P&L, сигналами в Telegram и визуализацией графика.
...
- Dry-run исполнение: pending orders → position → закрытие по SL/TP
...
- Управление из Telegram: отмена ордеров и ручное закрытие позиции (dry-run)
